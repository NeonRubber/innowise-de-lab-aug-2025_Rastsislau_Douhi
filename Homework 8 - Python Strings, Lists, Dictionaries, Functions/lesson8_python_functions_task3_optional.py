...
for student in student_data:
    print (f"{student['name']} имеет средний балл равный {calculate_average_score(student['scores']):.2f}, а без учёта минимального балла - {calculate_average_score(student['scores'], ignore_lowest=True):.2f}")
